...
vim.keymap.set('n', '<leader>fb', function() Snacks.picker.buffers() end, { desc = "get buffers" });
vim.keymap.set('n', '<leader>ff', function() Snacks.picker.files() end, { desc = "find files" });
vim.keymap.set('n', '<leader>fg', function() Snacks.picker.files() end, { desc = "find git files" });
